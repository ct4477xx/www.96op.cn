<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="租房管理">&#xe6b8;</i>
                    <cite>租房管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('房间管理','{{url('sys/house')}}')">
                            <i class="iconfont">&#xe70b;</i>
                            <cite>房间管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('人员管理','{{url('sys/tenant')}}')">
                            <i class="iconfont">&#xe6b8;</i>
                            <cite>人员管理</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('统计页面','{{url('sys/welcome1')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>统计页面</cite></a>
                    </li>
                    <li>
