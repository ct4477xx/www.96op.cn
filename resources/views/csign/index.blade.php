        ...
        <div class="col-xs-12 col-sm-6 col-md-8">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="margin-bottom: 0px;text-align-last: center;">
                        <a class="btn btn-default" href="../_Csign/?index.html" style="width: 220px;">确认</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                success:function(json) {
                    if(json.success){
                        ...
                        $(document).ready(function(){
                            ...
                            $("#homeName").val(json.homeName);
                            $("#users").text(json.users);
                            //$("#wrm").attr("src","../../../Plugin/qrcode/?index.html&text=<%=doMain%>/_t/?"+json.minUrl+".j&s=4");
                        })
