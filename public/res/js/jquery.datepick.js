...
function Datepicker() {
	this._defaults = {
		...
		monthsToShow: 3, // How many months to show, cols or [rows, cols]
		...
		dateFormat: 'yy-mm-dd', // Format for dates
		autoSize: false, // True to size the input field according to the date format
		rangeSelect: false, // Allows for selecting a date range on one date picker
		rangeSeparator: ' - ', // Text between two dates in a range
		multiSelect: 999, // Maximum number of selectable dates, zero for single select
	...
	this.regional = {
		'': { // US/English
			...
			closeText: '确定', // Text for the close command
			closeStatus: 'Close the datepicker', // Status text for the close command
			yearStatus: 'Change the year', // Status text for year selection
			monthStatus: 'Change the month', // Status text for month selection
			weekText: 'Wk', // Text for week of the year column header
			weekStatus: 'Week of the year', // Status text for week of the year column header
			dayStatus: '选择 DD, M d, yyyy', // Status text for selectable days
			defaultStatus: '选择 a date', // Status text shown by default
